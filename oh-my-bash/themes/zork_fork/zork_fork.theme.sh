...
my_ve(){
    ...
    then 
        ...
        my_ps_ve="${_my_blue_color}[${_omb_prompt_bold_purple}$ve${_my_blue_color}]${_omb_prompt_normal}";
        echo "$my_ps_ve";
    fi
    echo "";
    }
...
_omb_theme_PROMPT_COMMAND() {
    ...
    my_ps_host="${_my_prompt_color}\h${_omb_prompt_normal}";
    # yes, these are the the same for now ...
    # my_ps_host_root="${_omb_prompt_green}\h $(date_prompt)${_omb_prompt_normal}";
    my_ps_host_root="${_my_prompt_color}\h${_omb_prompt_normal}";
    ...
    # nice prompt
    case "`id -u`" in
        0) PS1="${TITLEBAR}${_my_blue_color}┌─${_omb_prompt_normal}$(chroot)${_my_blue_color}[$my_ps_user$my_ps_host_root${_my_blue_color}][${_my_prompt_color}$(date_prompt)${_my_blue_color}]${_omb_prompt_normal}$(my_ve)$(modern_scm_prompt)$(__my_rvm_ruby_version)$(is_vim_shell)
${_my_blue_color}│ [${_omb_prompt_normal}\w${_my_blue_color}]
${_my_blue_color}└─#${_omb_prompt_normal} "
        ;;
    *) PS1="${TITLEBAR}${_my_blue_color}┌─${_omb_prompt_normal}$(chroot)${_my_blue_color}[$my_ps_user$my_ps_host${_my_blue_color}][${_my_prompt_color}$(date_prompt)${_my_blue_color}]${_omb_prompt_normal}$(my_ve)$(modern_scm_prompt)$(__my_rvm_ruby_version)$(is_vim_shell)
${_my_blue_color}│ [${_omb_prompt_normal}\w${_my_blue_color}] 
${_my_blue_color}└─\$${_omb_prompt_normal} "
        ;;
    esac
