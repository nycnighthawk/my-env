#!/bin/bash
export TOOLCHAIN_DIR='/opt/llvm/clang/v8.0.1'
export VERBOSE=1
...
export LLVM_INSTALL_PATH=${TOOLCHAIN_DIR}
...
#export LDFLAGS="--rtlib=compiler-rt -Wl,-rpath,${LLVM_INSTALL_PATH}/lib64 -Wl,-z,origin -Wl,--enable-new-dtags"
OLD_PATH=${PATH}
