...
export LDFLAGS="-L${TOOLCHAIN_DIR}/lib64 -lc++ -lc++abi -Wl,-rpath,${LLVM_INSTALL_PATH}/lib64"
export LDFLAGS="${LDFLAGS} -Wl,-rpath,${GCC_DIR}/lib64 -Wl,-z,origin -Wl,--enable-new-dtags"
OLD_PATH=${PATH}
